...
import { Breadcrumb, BreadcrumbItem, Form, Row, Label, Col, Button } from 'reactstrap';
...
class ContactReduxComponent extends Component {
    constructor(props) {
        super(props);
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname" name="firstname" placeholder="first name"
                                        ...
                                        <Errors className="text-danger" model=".firstname" show="touched" 
                                            messages={{
                                            required:'Required',minLength:"miust be greater than 3",maxLength:"must be less than 15"
                                        }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum" placeholder="tel. num"
                                        ...
                                        <Errors className="text-danger" model=".telnum" show="touched" messages={{
                                            required:'Required',minLength:"miust be greater than 3 no",maxLength:"must be less than 15 no",isNumber:'must be anumber'
                                        }} />
...
export default ContactReduxComponent;