...
class Contact extends Component {
    ...
    //    const reg=/^\d+$/;
       ...
       if (this.state.touched.telnum && !reg.test(telnum))
           errors.telnum="telnum should be only numbers";
           
           if (this.state.touched.email && email.split('').filter(x => x === '@').length !==1) {
            errors.email = "email shoud conail @ sign";
        }    
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" placeholder="first name"
                                        value={this.state.firstname}  valid={errors.firstname===''} invalid={errors.firstname !== ''} onChange={this.handleInputChange} onBlur={this.handleblur('firstname')} />
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="telnum" name="telnum" placeholder="tel. num"
